...
def build_load_config(
    *,
    ...
    remote_instance_weight_transporter_protocol: Optional[str] = None,
    ...
    return LoadConfig(
        ...
        remote_instance_weight_loader_transfer_engine_protocol=remote_instance_weight_transporter_protocol,
